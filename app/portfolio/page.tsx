        ...
        <DrawerContent>
          ...
          <div className="px-4 md:px-6 pb-6 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20">
              ...
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-indigo-500/10 to-indigo-600/10 border border-indigo-500/20">
              ...
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/20">
