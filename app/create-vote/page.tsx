...
import { Calendar, DollarSign, Users, Info, Plus, X, ImageIcon } from 'lucide-react'
          ...
          <div className="grid gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <p className="text-xs text-muted-foreground my-5 my-5 my-0 my-5 my-5">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    max="10"
                  />
                  <p className="text-xs text-muted-foreground my-5 my-0 my-5 my-5">
