        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-foreground">PredictHub</span>
            </Link>
            <p className="text-sm text-muted-foreground max-w-md leading-relaxed mb-4">
              The world's most advanced decentralized prediction market platform. Trade on the future with confidence.
            </p>
            <div className="flex gap-3">
              <a
                href="https://x.com/PolyHubTech"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-muted hover:bg-primary/10 flex items-center justify-center transition-all group"
                aria-label="Twitter"
              >
                <svg
